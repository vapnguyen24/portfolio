document.addEventListener('DOMContentLoaded', () => {
    ...
    // initAnimations must run before initUI so animateSkills/animateProjects are available during render
    ...
    if (window.initAnimations) window.initAnimations(state);
